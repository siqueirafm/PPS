...
public:
   ...
   */
  Halfedge *get_first_halfedge() const { return _h1; }
   ...
   */
  Halfedge *get_second_halfedge() const { return _h2; }
   ...
   * boundary of the surface and the logic value false otherwise.
   */
  bool is_boundary_edge() const { return (_h1 == 0) || (_h2 == 0); }
   ...
   */
  void set_first_halfedge(Halfedge *h) { _h1 = h; }
   ...
   */
  void set_second_halfedge(Halfedge *h) { _h2 = h; }
   ...
   * edge.
   */
  EAttrib &get_attributes() { return _attributes; }
...
private:
  ...
  Halfedge *_h1 = nullptr; ///< Pointer to the first half-edge of this edge.
  Halfedge *_h2 = nullptr; ///< Pointer to the second half-edge of this edge.
